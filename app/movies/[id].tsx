...
const MovieInfo = ({label,value}:MovieInfoProps) => {
  return (
    <View className='flex-col items-start justigy-center mt-5'>
  ...
  return (
    <View className='bg-primary flex-1'>
     ...
     >
      ...
      <TouchableOpacity  className='absolute botton-5 left-0 right-0 mx-5 bg-accent rounded-lg py-3.5 flex flex-row items-center justify-center z-50' onPress={router.back}>
